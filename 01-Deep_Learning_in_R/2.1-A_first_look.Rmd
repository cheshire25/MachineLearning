...
<!-- #region {"id": "WRyox7gfuBAm", "colab_type": "text"} -->
# A first look at a neural network
<!-- #endregion -->

<!-- #region {"id": "wN9r0tf9uJQU", "colab_type": "text"} -->
...
```{r id=76ddd1gLwbpF, colab_type=code, colab={'base_uri': 'https://localhost:8080/', 'height': 612}, outputId=2f0d1733-58c8-4fc8-a2c6-6035847011d7}
devtools::install_github("rstudio/keras")
devtools::install_github("tidyverse/tidyverse")
```

```{r id=yuGiYqXNsnS-, colab_type=code, colab={'base_uri': 'https://localhost:8080/', 'height': 153}, outputId=8d532738-2690-4fa4-a809-68af2c48b971}
library(keras)
library(tidyverse)
mnist <- dataset_mnist()
...
<!-- #region {"id": "A59asAm_w4Ak", "colab_type": "text"} -->
...
```{r id=TW2x6Y9Dxmpt, colab_type=code, colab={'base_uri': 'https://localhost:8080/', 'height': 85}, outputId=a56d7a7d-77c4-40df-ee78-3ea67953cda8}
str(train_images)
...
<!-- #region {"id": "m8gY9ot-xr83", "colab_type": "text"} -->
...
```{r id=HqHmKqqyxuOF, colab_type=code, colab={}}
network <- keras_model_sequential() %>% 
  layer_dense(units = 512, activation = "relu", input_shape = c(28 * 28)) %>% 
  layer_dense(units = 10, activation = "softmax")
```

<!-- #region {"id": "Rq930t07xv45", "colab_type": "text"} -->
...
The exact purpose of the loss function and the optimizer will be made clear throughout the next two chapters. dfdfgd
<!-- #endregion -->

```{r id=8sTnXfooyBX5, colab_type=code, colab={}}
network %>% compile(
  optimizer = "rmsprop",
...
<!-- #region {"id": "WBbG9RSYyCus", "colab_type": "text"} -->
...
```{r id=Cj3q84RbyEbd, colab_type=code, colab={}}
...
<!-- #region {"id": "hbPNTg1gyGMy", "colab_type": "text"} -->
We also need to categorically encode the labels, a step which we explain in chapter 3:

<!-- #endregion -->

```{r id=odgeCDsKyHdL, colab_type=code, colab={}}
train_labels <- to_categorical(train_labels)
test_labels <- to_categorical(test_labels)
```

<!-- #region {"id": "evRKYyM0yJJS", "colab_type": "text"} -->
We are now ready to train our network, which in Keras is done via a call to the `fit` method of the network: we "fit" the model to its training data.

<!-- #endregion -->

```{r id=nT9adii-yKtS, colab_type=code, colab={}}
network %>% fit(train_images, train_labels, epochs = 5, batch_size = 128)

```

<!-- #region {"id": "nXzsj4ZYyMP4", "colab_type": "text"} -->
...
```{r id=CLzelS7XyNus, colab_type=code, colab={'base_uri': 'https://localhost:8080/', 'height': 113}, outputId=ccd2db08-db79-4a31-ec6b-ae90aa0171bf}
metrics <- network %>% evaluate(test_images, test_labels, verbose = 0)
metrics
```

<!-- #region {"id": "b04LSE7ZwrvP", "colab_type": "text"} -->
